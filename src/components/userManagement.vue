        ...
        <el-row class="topSearch">
          <el-col :span="24">
            <el-form :inline="true" :model="queryParams" class="demo-form-inline">
              ...
              <el-form-item>
                <el-button type="success" @click="exportServiceQuery">导出</el-button>
              </el-form-item>
            </el-form>
          </el-col>
        </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit(e){
        ...
        /*查询请求*/
        this.$axios.get('/api/serves/list', {params: this.queryParams}).then((data) => {
...
//                  }
    ...
    beforeCreate(){
      /*得到服务类型*/
      this.$axios.get('/api/constants').then((data) => {
    ...
    mounted(){
      /* this.$axios.get('/api/main/rooms').then((data) => {
       console.log(data)
       })*/
    }
